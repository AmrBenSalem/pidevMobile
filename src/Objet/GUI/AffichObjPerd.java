 ...
 * @author bader
 */
public class AffichObjPerd extends SliderBridge implements Animation, StyleListener {
    ...
    public AffichObjPerd() {
        ...
        System.out.println("retour objets perdu" + x);
        ArrayList<Objet> listobjet = objserv.findAllObjetslost(x);
        ...
        for (Objet o : listobjet) {
            ...
            System.out.println(o.getNature());
